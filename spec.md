...
- **組み合わせ数**: 3個
- **数値の範囲**: 36〜225
- **例**: 42 (2×3×7), 70 (2×5×7), 105 (3×5×7)

#### レベル3（中級）
- **使用する素数**: 2, 3, 5, 7, 11
- **組み合わせ数**: 4個
- **数値の範囲**: 132〜1100
- **例**: 210 (2×3×5×7), 462 (2×3×7×11), 770 (2×5×7×11)
...
1. レベル1 (素数: 2,3,5,7 / 2個 / 数字6〜70)
2. レベル2 (素数: 2,3,5,7 / 3個 / 数字36〜225)
3. レベル3 (素数: 2,3,5,7,11 / 4個 / 数字132〜1100)
4. レベル4 (素数: 2,3,5,7,11 / 4〜5個 / 数字1089〜10500)
...
- **SoSpeed**: メインゲームクラス
  - 定数:
    ...
    - `DIFFICULTY_SETTINGS`: 難易度設定のハッシュ
      ...
      - 各レベル: name（名前）、primes（使用素数）、factor_count（組み合わせ数）、min_number（数値下限）、max_number（数値上限）
